...
export default {
 slashOnly:true,communityRelease:true,category:'Community',
 data:new SlashCommandBuilder().setName('beta-staff').setDescription('DexzuBot staff tools').setDMPermission(false)
