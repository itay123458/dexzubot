...
try {
  ...
  assert.deepEqual((await (await fetch(`${base}/releases`)).json()).releases.map(release=>release.id), ['2026-09-24-music-search','2026-09-17-dashboard-access','2026-09-17-community-release']);
